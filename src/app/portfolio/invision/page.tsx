      ...
      <article className="page-article">
        ...
        <div className="invision-hero">
          <RidgelineCanvas
            ...
            animate="breath"
          />
          <span className="viz-credit">Data source: <a href="https://kp.gfz-potsdam.de/" target="_blank" rel="noopener noreferrer">Planetary Ap index</a> · GFZ Potsdam · 1990–2019</span>
